...
from homeassistant.components.vacuum import SUPPORT_STATE, SUPPORT_START, \
    SUPPORT_STOP, SUPPORT_FAN_SPEED, SUPPORT_BATTERY, STATE_PAUSED, STATE_IDLE, STATE_DOCKED, \
    STATE_CLEANING, STATE_RETURNING, STATE_ERROR, SUPPORT_PAUSE, SUPPORT_RETURN_HOME, StateVacuumEntity
...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    async_add_entities([SmartThingsVacuum(device) for device in broker.devices.values()
